...
// Zero should never be compared with == or != directly, please use decimal.Eq or decimal.Cmp instead.
var Zero = New(0, 1)
...
// UnmarshalBinary implements the encoding.BinaryUnmarshaler interface. Alias a string representation
...
func (d Decimal) RedisDecimal() *RedisDecimal {
	return &RedisDecimal{
		Decimal: d,
	}
}
